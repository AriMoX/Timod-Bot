...
START_TEXT = (
    ...
    "🎬 **جستجو و دانلود فیلم و سریال (جدید 🌟):**\n"
    "• کافیست نام هر فیلم یا سریالی را بفرستید (مثلاً `Inception` یا `بتمن` یا دستور `/movie نام فیلم`) تا تمام کیفیت‌ها، دوبله، زیرنویس و حجم فایل‌ها در قالب دکمه شیشه‌ای برای دانلود مستقیم آماده شوند!\n\n"
    "🔍 **جستجوی اینلاین موزیک در چت‌ها:**\n"
    ...
    "✨ **ساخت استیکر حرفه‌ای:**\n"
    "• عکس یا ویدیو و گیف بفرست تا درجا تبدیل به **استیکر یا استیکر متحرک** بشه! (با قابلیت انتخاب ایموجی) 🎨\n\n"
    "🚀 همین الان یک فیلم، ویدیو یا لینک دلخواهت رو ارسال کن یا نام اثر رو جستجو کن!"
)

HELP_TEXT = (
    "📖 **راهنمای جامع استفاده:**\n\n"
    "🎬 **دانلود فیلم و سریال:**\n"
    "   کافیست نام فیلم یا سریال را بفرستید (یا با دستور `/movie Inception`)\n"
    "   لیست کیفیت‌ها و حجم‌ها برای دانلود مستقیم نمایش داده می‌شود.\n\n"
